...
- ASLP-lab/MeanVC2's README download section does not make the manual `wavlm_large_finetune.pth` requirement obvious; keep local setup docs and debug checks explicit for the WavLM speaker-embedding files.
